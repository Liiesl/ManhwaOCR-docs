...
description: How to start the Easy Scanlate and what to expect on first launch.
order: 3
---

# Launching the Application

Once installed, you can launch the "Easy Scanlate" from your system's application menu (Start Menu on Windows, Applications folder on macOS). If you are running from source, execute `python main.py` in your terminal from the project directory.
